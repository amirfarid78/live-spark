    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="flex-1 flex flex-col justify-center px-6 pb-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground mt-1">Sign in to continue to StreamVerse</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-end">
            <Link to="/forgot-password" className="text-sm text-stream-purple hover:underline">
              Forgot password?
            </Link>
          </div>
        ...
        <p className="text-center mt-8 text-muted-foreground">
          ...
          <Link to="/signup" className="text-stream-purple font-semibold hover:underline">
            Sign Up
          </Link>
        </p>
      </div>
